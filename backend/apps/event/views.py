...
# Импорт схем swagger
from apps.event.swagger_schemas import (
    GAMES_ARCHIVE_GET_SCHEMA,
    GAMES_DETAIL_DELETE_SCHEMA,
    GAMES_DETAIL_GET_SCHEMA,
    GAMES_INVITE_PLAYERS_POST_SCHEMA,
    GAMES_INVITES_DELETE_SCHEMA,
    GAMES_INVITES_GET_SCHEMA,
    GAMES_JOIN_GAME_POST_SCHEMA,
    GAMES_MY_GAMES_GET_SCHEMA,
    GAMES_POST_SCHEMA,
    GAMES_PREVIEW_GET_SCHEMA,
    GAMES_RATE_PLAYERS_GET_SCHEMA,
    GAMES_RATE_PLAYERS_POST_SCHEMA,
    GAMES_UPCOMING_GET_SCHEMA,
)
...
class GameViewSet(
    ...
    @swagger_auto_schema(**GAMES_INVITE_PLAYERS_POST_SCHEMA)
    @action(
        methods=['post'],
        detail=True,
    ...
    @swagger_auto_schema(**GAMES_PREVIEW_GET_SCHEMA)
    ...
    @swagger_auto_schema(**GAMES_MY_GAMES_GET_SCHEMA)
    ...
    @swagger_auto_schema(**GAMES_ARCHIVE_GET_SCHEMA)
    ...
    @swagger_auto_schema(**GAMES_INVITES_GET_SCHEMA)
    ...
    @swagger_auto_schema(**GAMES_UPCOMING_GET_SCHEMA)
    ...
    @swagger_auto_schema(**GAMES_JOIN_GAME_POST_SCHEMA)
    @action(
        methods=['post'],
        detail=True,
        url_path='join-game',
    ...
    @swagger_auto_schema(**GAMES_INVITES_DELETE_SCHEMA)
    @action(
        methods=['delete'],
        detail=True,
        url_path='invites',
    ...
    @swagger_auto_schema(**GAMES_RATE_PLAYERS_GET_SCHEMA)
    @swagger_auto_schema(**GAMES_RATE_PLAYERS_POST_SCHEMA)
    @action(
        methods=['get', 'post'],
        detail=True,
    ...
    @swagger_auto_schema(**GAMES_POST_SCHEMA)
    def create(self, request, *args, **kwargs):
        return super().create(request, *args, **kwargs)

    @swagger_auto_schema(**GAMES_DETAIL_GET_SCHEMA)
    def retrieve(self, request, *args, **kwargs):
        return super().retrieve(request, *args, **kwargs)

    @swagger_auto_schema(**GAMES_DETAIL_DELETE_SCHEMA)
