...
class TestFCMApi:
    ...
    def test_fcm_token_put_success(
        self, fcm_token_url, authenticated_client, fcm_token_data
    ):
        ...
        assert device.player.user == user
        assert device.is_active is True

    def test_fcm_token_update_existing(
        self, fcm_token_url, authenticated_client, existing_device
    ):
    ...
    def test_fcm_token_invalid_data(
        self, fcm_token_url, authenticated_client, invalid_fcm_token_data
    ):
