...
class TestGameAPI:
    ...
    def test_for_invite_creation(
        ...
        url = reverse('api:games-invite-players', args=(game_thailand.id,))
    ...
    def test_deleting_game_by_host(
        self, api_client_thailand, game_thailand, game_for_args
    ):
    ...
    def test_deleting_game_by_non_host(
        self, player_thailand_female_pro, game_thailand, game_for_args, client
    ):
...
class TestGameSerializers:
    ...
    def test_create_game_with_wrong_data(
        self, game_create_data, api_client_thailand, field, value
    ):
    ...
    def test_level_validation_in_game_invitation(
        self, player_thailand_female_pro, api_client_thailand, game_for_args
    ):
        response = api_client_thailand.post(
...
class TestGameFiltering:
    def test_preview_filtering(
        self, api_client_thailand, game_data, game_thailand, player_thailand
    ):
    ...
    def test_archive_filtering(
        ...
        game_thailand_with_players.start_time = now() - timedelta(weeks=520)
        game_thailand_with_players.save()
        assert Game.objects.count() == 2
